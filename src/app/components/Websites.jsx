...
const Websites = () => {
  ...
  return (
    <div className={home.websites}>
      <Grid container alignItems={'center'} rowGap={-6} justifyContent={'space-between'} pb={{ xs: '150px', lg: '0px' }}>
        ...
        <Grid item xs={12} lg={6}>
          <Box textAlign={{ xs: 'center', lg: 'left' }} width={'80%'} margin='auto'>
            <Typography color='info' className={home['title-moon']} mb={4}>Websites</Typography>
