                ...
                openST !== "none" && <Box sx={{ position: 'relative', }}>
                    <Box className={header[openST]} >
                        <Box className={header.fastLinks} sx={{ alignItems: alignItems }}>
                            <Box>
                                <Box sx={{ position: 'absolute', top: 9, right: 7 }}><Picture onClick={closeST} center={false} src={'/close.svg'} width={48} height={48} alt={'logo'} periorty style={{ cursor: 'pointer' }} /></Box>
